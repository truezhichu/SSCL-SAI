...
class eval_model(modelSSCL):
    ...
    def create_data_file(self, file_ = 'train.txt'):
    ...
    def reporter(self, nats_dir = '../nats_results', model_id=None, file_top_sentence = 'top_sentence.txt'):
        nats_dir = nats_dir
        file_top_sentence = file_top_sentence
